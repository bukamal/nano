...
SCRIPTS = [
    ...
    "tools/sound_system_smoke_test.py",
    ...
    "tools/qeid_reference_design_phase1_smoke_test.py",
    "tools/qeid_reference_design_phase2_smoke_test.py",
    "tools/definitions_management_smoke_test.py",

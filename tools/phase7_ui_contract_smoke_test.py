...
admin = (ROOT / "src/qeid_offline/views/admin_view.py").read_text(encoding="utf-8")
docs = (ROOT / "src/qeid_offline/services/document_service.py").read_text(encoding="utf-8")
...
for needle in ["مشاركة النسخة", "استيراد نسخة من الجهاز", "pick_file", "share_file", "qeidbackup"]:

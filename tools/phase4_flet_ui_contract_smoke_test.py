...
view = (ROOT / "src/nano_offline/views/reports_view.py").read_text(encoding="utf-8")
ctx = (ROOT / "src/nano_offline/app_context.py").read_text(encoding="utf-8")
